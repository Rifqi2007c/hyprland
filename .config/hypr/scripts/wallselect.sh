...
## gtk app
#gsettings set org.gnome.desktop.interface gtk-theme 'Adapta' && gsettings set org.gnome.desktop.interface gtk-theme 'PywalTheme'

## gtk app (nixos workaround)
dconf write /org/gnome/desktop/interface/gtk-theme '"Adapta"' && dconf write /org/gnome/desktop/interface/gtk-theme '"PywalTheme"'
