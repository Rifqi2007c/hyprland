...
killall cava
killall waybar
swww img "$HOME/.config/hypr/wallpapers/loading_smoothed_nes.gif" --transition-type outer --transition-duration 1 --transition-fps 60 --transition-step 20 && sleep 2.6
swww img "${wall_dir}"/"${wall_selection}" --transition-type center --transition-duration 1 --transition-fps 60 --transition-step 20 && sleep 0.7
