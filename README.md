# requirement (Im on arch base distro - endeavoros)
 - sudo pacman -S hyprland network-manager-applet dunst rofi pipewire pavucontrol imagemagick fish ranger nwg-look neovim firefox foot ttf-0xproto-nerd slurp grim libnotify starship python-pywal
